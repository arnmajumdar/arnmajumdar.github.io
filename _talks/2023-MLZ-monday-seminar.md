...
Topic: Development of methods to analyze in situ Small Angle Neutron Scattering (SANS) sata using computer simulation.
...
[Link to conference website](https://indico.frm2.tum.de/event/434/)
